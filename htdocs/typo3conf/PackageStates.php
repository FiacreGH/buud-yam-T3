...
return [
    'packages' => [
        ...
        'speciality' => [
            'composerName' => 'speciality',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/speciality/',
            'suggestions' => [],
        ],
        'vidi' => [
            'composerName' => 'fab/vidi',
            'state' => 'active',
        ...
        'media' => [
            ...
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/media/',
            'suggestions' => [
                'filemetadata',
            ],
        ],
        ...
        'vidi_frontend' => [
            ...
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/vidi_frontend/',
            'suggestions' => [],
        ],
        'nc_staticfilecache' => [
